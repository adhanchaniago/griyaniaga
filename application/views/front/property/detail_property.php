          ...
          <div class="card-body">
            ...
            <div class="entry-content">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="row">
                    <label class="col-6"><b>ID Iklan</b> </label>
                    <div class="col-6">: <?php echo $property->id_iklan; ?></div>
                    <label class="col-6"><b>Harga </b></label>
                    <div class="col-6">: Rp. <?php echo number_format($property->property_price, '0', ',', '.'); ?></div>

                    <label class="col-6"><b>Kamar Tidur </b></label>
                    <div class="col-6">: <?php echo $property->property_bed; ?></div>
                    <label class="col-6"><b>Kamar Mandi </b></label>
                    <div class="col-6">: <?php echo $property->property_bath; ?></div>
                    <label class="col-6"><b>K. Tidur Pembantu </b></label>
                    <div class="col-6">: <?php echo $property->property_bed_maid; ?></div>
                    <label class="col-6"><b>K. Mandi Pembantu </b></label>
                    <div class="col-6">: <?php echo $property->property_bath_maid; ?></div>

                  </div>
                </div>
                <div class="col-md-6">
                  <div class="row">
                    <label class="col-6"><b>Sertifikat </b></label>
                    <div class="col-6">: <?php echo $property->property_certificate; ?></div>
                    <label class="col-6"><b>Luas Tanah </b></label>
                    <div class="col-6">: <?php echo $property->property_surfacearea; ?> M<sup>2</sup></div>

                    <label class="col-6"><b>Bangunan </b></label>
                    <div class="col-6">: <?php echo $property->property_buildingarea; ?> M<sup>2</sup></div>
                    <label class="col-6"><b>Jumlah Lantai </b></label>
                    <div class="col-6">: <?php echo $property->property_floor; ?> Lantai</div>
                    <label class="col-6"><b>Daya Listrik </b></label>
                    <div class="col-6">: <?php echo $property->property_electrical; ?> </div>
                    <label class="col-6"><b>Garasi </b></label>
                    <div class="col-6">: <?php echo $property->property_garage; ?></div>
                  </div>
                </div>
              </div>
              <h2 class="entry-title">
