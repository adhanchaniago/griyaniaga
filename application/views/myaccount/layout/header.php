...
<head>
    ...
    <link href="<?php echo base_url('assets/img/logo/' . $meta->favicon); ?>" rel="icon">
    <title>Admin - <?php echo $meta->title; ?></title>
    <link href="<?php echo base_url('assets/admin/vendor/fontawesome-free/css/all.min.css'); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url('assets/admin/vendor/bootstrap/css/bootstrap.css'); ?>" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo base_url('assets/template/icon/remixicon/remixicon.css'); ?>" rel="stylesheet">
