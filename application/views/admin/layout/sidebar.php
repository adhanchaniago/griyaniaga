...
<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <?php if ($user->role_id == 1) : ?>
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('admin/property'); ?>">
                <i class="fa-fw ti-home text-primary"></i>
                <span>Property</span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('admin/province'); ?>">
                <i class="fa-fw ti-map text-primary"></i>
                <span>Provinsi</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('admin/type'); ?>">
                <i class="fa-fw ti-crown text-primary"></i>
